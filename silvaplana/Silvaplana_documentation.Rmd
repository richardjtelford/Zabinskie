...
Because of the similarities between Silvaplana, Zabinskie and Seebergsee [@LarocqueTobler2011b; @LarocqueTobler2012], the equivalent data should be archived for this lake. Other papers dependent on the Silvaplana chironomid stratigraphy, for example Larocque et al [-@Larocque-Tobler2011], also need to be evaluated.
