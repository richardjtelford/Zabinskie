...
The calibration set also has problems. Lac A and Lac H have identical assemblages, except that the percentages in Lac H have been multiplied by `r readd(lac_AH)$min_lac_H %>% format(digits = 3)` such that they sum to `r readd(lac_AH)$sum_lac_H`%. The warmest Canadian lake is reported to have a mean August temperature of `r max(readd(env))`°C which is warmer than anywhere in Quebec and adjacent areas [@Fick2017].
