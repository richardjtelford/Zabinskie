...
Of the four correlations, only one matches the correlation of data digitised from the authors' figure 4 -- Alanen Laanijavri `r stopifnot(readd(abisko_checked))`. For the other lakes, the correlations are 
