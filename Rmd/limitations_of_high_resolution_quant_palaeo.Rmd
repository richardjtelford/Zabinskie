...
Hernández-Almeida et al. [-@HernandezAlmeida2015b];Chrysophytes;Calcium concentration;Lake Żabińskie;Annual (3 year smooth);0.5 vs May--Oct. zonal wind speed*
Hernández-Almeida et al. [-@HernandezAlmeida2015];Chrysophytes;No. consecutive days with water < 4°C;Lake Żabińskie;Annual (3 year smooth);0.35 vs Jan.--March air T*
...
'Larocque-Tobler et al. [-@Larocque-Tobler2015; -@Larocque-Tobler2016]';Chironomids;August air-T;Lake Żabińskie;Mostly annual;0.76*
...
```{r weather-climate-plot, fig.cap = "Correlation between August and June (green), and August and summer temperatures (orange) averaged over different length periods in the central England temperature series [@Parker1992]. Smoother is a loess with span = 0.75.", fig.width = 90/25.4, fig.height=60/25.4}
...
readd(silva_combined_recon_plots)
```
...
The instrumental temperature series used for the calibration-in-time reconstruction [@Larocque-Tobler2011] differs substantially from the series used in the 150-year calibation in space paper. Neither version of the instrumental data can be reconsiled with the July temperature data from Segl-Maria.
...
I thank all my colleagues in Bergen and elsewhere who have given the help, advice, and encouragement needed to write this manuscript. I thank Dr Gavin Simpson and three anonymous reviewers for their constructive comments. This work was partially funded by the Norwegian Research Council FriMedBio project palaeoDrivers (213607). Code to reproduce all the analyses shown above is archived at [https://github.com/richardjtelford/Zabinskie](https://github.com/richardjtelford/Zabinskie).
