...
But why does the RMSEP incease with gradient length? There are two possible explanations: 
 ...
 1. With a larger temperature range, cross-validation predictions are less constrained - it is possible to be more wrong. If this is true, it would suggest that transfer functions with a small temperature range have artificially reduced uncertainties.
