...
marcott_850 %>% mutate(newAge = Depth * 10/0.13, delta = Age - newAge) %>% ggplot(aes(x = Depth, y = delta)) + geom_path() + geom_rug(data = data_frame(), aes(x = c(32.5, 49.5, 72.5, 96.5, 106.5)), inherit.aes = FALSE)
