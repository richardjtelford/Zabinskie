...
This section explores the challenges faced by sub-decadal resolution reconstructions, focusing on chironomid inferred-air temperature reconstructions. Other reconstructions based on assemblages of other microfossil assemblages, for example pollen or diatoms, will have a overlapping set of challenges [@Peglar1993]. Many of these challenges will also affect sedimentary geochemical proxies to some extent. 
