...
Several of the papers discussed above would appear to need, at the least, corrections issuing to account for the discrepancies and errors. Data and computer code that allow the results to be reproduced should be archived so readers may be assured that the results are reproducible.
...
The number and severity of errors in the papers reviewed highlights the importance of archiving all the raw data and computer code needed to reproduce the results.
