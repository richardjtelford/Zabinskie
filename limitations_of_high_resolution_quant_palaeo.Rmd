...
Calibration-in-time models are routinely used in dendroclimatology [@Sheppard2010]. They have been used in palaeolimnology where calibration-in-space models are not appropriate because the model need tailoring to a specific site. For example, they have been used to calibrate varve thickness against climate, especially for reconstructing summer temperature from proglacial lakes [@Leemann1994; @Thomas2009]; mass accummulation rate against winter precipitation [@Elbert2012]; and temperature from reflectance spectroscopy measurements
