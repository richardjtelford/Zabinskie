---
title: "The limits of high-resolution quantitative palaeoecology"
author: |
  | Richard J. Telford 
...
# Highlights{-}
 ...
 - Microfossil assemblage-based reconstructions with sub-decadal resolution that are validated against instrumental records are reviewed.
...
**Keywords:** Air temperature; Microfossils; Quantitative palaeoenvironmental reconstructions; Transfer functions; Reproducibility; Anthropocene; Palaeoclimatology; Palaeolimnology; Global; Data treatment, data analysis
...
This section explores the challenges faced by sub-decadal resolution reconstructions, focusing on chironomid inferred-air temperature reconstructions. Other proxies, for example pollen, will have a overlapping set of challenges.
...
Current data archiving policies in Quaternary science journals are either inadequate or unenforced. The _Journal of Paleolimnology_ advises that authors "may" deposit data in the publishers system or an official repository. _Quaternary Science Reviews_ and _Palaeogeography, Palaeoclimatology, Palaeoecology_ "encourages" authors to share data "where appropriate". _The Holocene_ employs slightly stronger language: it "requests" that all authors submit "any primary data", but as few of the recent papers have links to data it appears that this policy is not enforced. In contrast, _Ecological Monographs_ makes the archiving of "all data" a "condition for publication". Quaternary science journals should adopt and enforce a similar policy: all the raw data required to reproduce all the results shown in the paper should be archived [@Simonsohn2013]. Stricter data archiving policies have been shown [@Giofre2017; @Nuijten2017] to increase the proportion of papers archiving data. Data should also be made available for reviewers before publication, who should treat it, like the manuscript, as confidential until the paper is published. 
