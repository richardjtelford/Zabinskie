...
No fossil data have been archived from the anoxic Seebergsee. Larocque-Tobler et al [-@LarocqueTobler2011b] report that adjacent fossil samples were merged until there were at least 30 chironomids. However inspection of Figure 4 a & b in Larocque-Tobler et al [-@LarocqueTobler2011b] strongly suggests that the count sum in many samples was much lower than this. For example, the oldest sample has one taxon at 66% and a second at 33%. The sum of the total abundances shown in Figure 4a for the three samples merged into the oldest sample is 12, far below the reported threshold of 30. Curiously, the lowest count observed in Figure 4a is four chironomids and all differences in abundances are multiples of four. Since the rarest taxa the fossil data is almost certainly present with a single individual, the likelihood that all counts are multiples of four is infinitesimally small. This suggests that the counts have been multiplied by four and that the true count sum for the oldest sample is three head capsules. 
